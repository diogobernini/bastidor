...
// 256) usado só pra prévia do diálogo). Injetado no ObjectCanvas via
// host.decodeDataURLImage — ver boot().
...
async function boot() {
  ...
  if (window.ObjectCanvas) {
    ...
    ObjectCanvas.init({
      ...
      updateToolbarEnabled,
      requestRender,
      decodeDataURLImage, // issue #29 fase 2: regenerar um objeto raster-trace precisa da imagem de volta
    });
  }
